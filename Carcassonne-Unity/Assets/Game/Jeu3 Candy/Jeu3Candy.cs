...
public class Jeu3Candy : Game, ITextureReceiver,
    IPointerDownHandler,
    IPointerUpHandler
{
    ...
    public override void launchGame()
    {
        ...
        for (int i = 0; i < numDechets; i++)
        {
            ...
            Debug.Log("Load dechet " + "dechets/" + dechets[i].id + ".png");
    ...
    {
        Debug.Log("Check associate candies");
        ...
        for (int i=0;i<numItems;i++)
        {
            ...
            {
                Debug.Log("Association found with " + c.x + "," + c.y + " : " + d);
        ...
        if(!found)
        {
            Debug.Log("No more associations, restore interaction");
            animating = false;
        }
